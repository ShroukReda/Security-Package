...
namespace SecurityLibrary
{
    public class Monoalphabetic : ICryptographicTechnique<string, string>
    {
        ...
        public string AnalyseUsingCharFrequency(string cipher)
        {
            ...
            //{
            //    if (((pair2.Value * 100 / cipher.Length) <= 3 && (pair2.Value * 100 / cipher.Length) >= 2.17) || ((pair2.Value * 100 / cipher.Length) <= 4.7 && (pair2.Value * 100 / cipher.Length) >= 3.9) || ((pair2.Value * 100 / cipher.Length) <= 0.27 && (pair2.Value * 100 / cipher.Length) >= 0.24))
            //    {
            //        outliers.Add(pair2.Key, pair2.Value);
            //        // saved.Remove(pair2.Key);
            //    }
            //}
            //foreach (KeyValuePair<char, double> pair2 in outliers)
            //{
            //    if (characterCount.ContainsValue(pair2.Value))
            //    {
            //        characterCount.Remove(pair2.Key);
            //    }
            //}
            //foreach (KeyValuePair<char, double> pair2 in freq)
            //{
            //    if ((((pair2.Value) <= 2.71 && (pair2.Value) >= 2) || ((pair2.Value) <= 5.5 && (pair2.Value) >= 4.14)) || ((pair2.Value) <= 0.20 && (pair2.Value) >= 0.16))
            //    {
            //        outliers2.Add(pair2.Key, pair2.Value);
            //        //saved2.Remove(pair2.Key);
            //    }
            //}
            //foreach (KeyValuePair<char, double> pair2 in outliers2)
            //{
            //    if (freq.ContainsValue(pair2.Value))
            //    {
            //        freq.Remove(pair2.Key);
            //    }
            //}
            //for (int y = 0; y < 4; y++)
            //{
            //    var minv = outliers.Values.Min();
            //    foreach (KeyValuePair<char, double> pair2 in outliers)
            //    {
            //        if (pair2.Value == minv)
            //        {
            //            maxKey2 = pair2.Key;
            //            outliers.Remove(pair2.Key);
            //            break;
            //        }
            //    }
            //    double min = 999;
            //    double diff = 0;
            //    foreach (KeyValuePair<char, double> pair in outliers2)
            //    {
            //        diff = Math.Abs((pair.Value - (minv * 100 / cipher.Length)));
            //        if (diff < min)
            //        {
            //            min = diff;
            //            target = pair.Value;
            ...
            //            key = pair.Key;
            //            freq.Remove(key);
            //            outliers2.Remove(key);
            //            break;
            //        }
            //    }
            //    if (cipher.Contains(maxKey2.ToString().ToUpper()))
            //    {
            //        cipher = cipher.Replace(maxKey2.ToString().ToUpper(), key.ToString().ToLower());
            //    }
            //}
            //for (int y = 0; y < 4; y++)
            //{
            //    var minv = outliers.Values.Max();
            //    foreach (KeyValuePair<char, double> pair2 in outliers)
            //    {
